...
export const RightBtnEnableContext = createContext<RightBtnEnableType>({
    ...
    headSensor: '@O_0#TR0',
    setHeadSensor: ()=>{},
    greenEnabledValue: '@G_1#TR0',
    setGreenEnabledValue: () => { },
    redEnabledValue: '@R_1#TR0',
    setRedEnabledValue: () => { },
...
export const RightBtnEnableProvider: FC<PropsWithChildren> = ({ children }) => {
    ...
    const [greenEnabledValue,setGreenEnabledValue]= useState('@G_1#TR0')
    const [redEnabledValue,setRedEnabledValue] = useState('@R_1#TR0')
    ...
    const [pointerValue, setPointerValue] = useState('@LA0#TR0');
